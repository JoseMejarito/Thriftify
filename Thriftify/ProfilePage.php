...
if (isset($_GET["user_id"])) {
    ...
    // If no specific user ID is provided, show the current user's profile
...
<body style="font-family: 'Bebas Neue', serif;">
        ...
        <div class="container py-4 py-xl-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2><?php echo $listing['seller_name']; ?>'s Listings</h2>
                </div>
            </div>
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                ...
                if (empty($listings)) {
                    echo '<div class="col-md-8 col-xl-6 text-center mx-auto">
                            <p>No listings to show for this user</p>
                        </div>';
                } else {
                            ...
                            <div class="card" type="button" onclick="redirectToItemPage(' . $listing['listing_id'] . ');">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    if ($_SESSION["user_id"] != $user_id) {
                                        echo '<button class="btn btn-dark me-2" type="button" onclick="addToWishlist(' . $listing["listing_id"] . ');">Add to Wishlist</button>';
                                    } else {
                                        echo '<a href="edit_listing.php?listing_id=' . $listing['listing_id'] . '" class="btn btn-dark">Edit</a>
    ...
    <script>
        function redirectToItemPage(listingId) {
            // Construct the URL for ItemPage.php with the listing_id parameter
            var url = 'ItemPage.php?listing_id=' + listingId;
